...
//
// Variante sin destornillador ("sacarConUnToque"): el tornillo sale con un toque del control. La usa
// la chapa del cajón del Cuarto 2, donde no hay destornillador. Para eso el tornillo lleva además un
// XR Simple Interactable y su collider NO es "Is Trigger", porque el rayo del control tiene que tocarlo.
...
public class Screw : MonoBehaviour
{
    ...
    // Un toque y el tornillo sale entero, igual que cuando termina de desatornillarse
